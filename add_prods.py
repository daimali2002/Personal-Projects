...
class ProdApp(Flask):
    def __init__(self, *args, **kwargs):
        ...
        self.route('/getall', methods=['GET'])(self.getall)
        self.route('/getone', methods=['GET'])(self.getone)
        self.route('/updatevals', methods=['PATCH'])(self.updatevals)
        self.route('/deleteprod', methods=['DELETE'])(self.deleteprod)
        self.route('/insertProd', methods=['POST'])(self.insertProd)
    ...
    def updatevals(self):
        try:
            ...
            update_prods(id,title,description,category,price,rating,stock,brand)
    ...
    def insertProd(self):
        try:
            ...
            num = insert_prods(id,title,description,category,price,rating,stock,brand)
